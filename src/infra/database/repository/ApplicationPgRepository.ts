    ...
    public async getOne(criteria: number): Promise<ApplicationEntity> {
        ...
        const result = await this.conn.query(sql`
                SELECT 
                    ...
                    a.available_marketing_samples, a.rtf, a.certifications, a.streams, a.marketing_doc, a.certificatespecdoc, a.fast_track,a.level_of_clearance,a.certificates,
    ...
    public async create(entity: ApplicationEntity, tx?: DatabaseTransactionConnectionType): Promise<number> {
        ...
        const result = await this.conn.query(sql`
                INSERT INTO application (
                    ...
                    rtf, certifications, streams, a.marketing_doc, a.certificatespecdoc, fast_track,level_of_clearance,certificates,
                    ...
                    ${JSON.stringify(entity.marketing_doc)}, ${JSON.stringify(entity.fast_track)},${entity.level_of_clearance}, ${JSON.stringify(entity.certificates)},
                    ${JSON.stringify(entity.certificatespecdoc)}, ${JSON.stringify(entity.fast_track)},${entity.level_of_clearance}, ${JSON.stringify(entity.certificates)},
