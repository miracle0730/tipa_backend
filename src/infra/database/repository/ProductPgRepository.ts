    ...
    public async getOne(criteria: number): Promise<ProductEntity> {
        ...
        const result = await this.conn.query(sql`
                SELECT 
                    ...
                    p.tds, p.msds, p.technical_considerations, p.width, p.features, p.segment, p.segment_type,
    ...
    public async create(entity: ProductEntity, tx?: DatabaseTransactionConnectionType): Promise<number> {
        ...
        const result = await this.conn.query(sql`
                INSERT INTO product (
                    ...
                    technical_considerations, tds, msds, certifications, draft, terms_and_limitations, manufacturing_technique, application,
                    ...
                    ${JSON.stringify(entity.tds)}, ${JSON.stringify(entity.msds)}, ${JSON.stringify(entity.certifications)}, ${entity.draft}, 
